...
export default function Student({ studentID }) {
  ...
  const items = [
    ...
    {
      label: (
        <Link href={`/student/profile/accountSetting`}>Account Setting</Link>
      ),
      key: "1",
    },
              ...
              <Col className={styles.navbar_section_items} span={19}>
                ...
                >
                  {isLogin ? (
                    <>
                      ...
                      >
                        <Dropdown
                          ...
                          trigger={["click"]}
                          className={
                            styles.navbar_section_items_section_2_dropdown
                          }
                        >
                          <button
                            className={
                    ...
                    <>
                      <Col>{/* //search bar (if wanna do) */}</Col>
                      <Col>
                        <Row>
                          <Col style={{ marginRight: 15 }}>
                            <Link href="/student/signup">
                              <Button className={styles.authFont}>
                                <span className={styles.authFont}>
                                  Create account
                                </span>
                              </Button>
                            </Link>
                          ...
                          <Col>
                            <Link href="/student/login">
                              <Button type="primary">
                                <span className={styles.authFont}>Sign in</span>
                              </Button>
                            </Link>
                          </Col>
                        </Row>
